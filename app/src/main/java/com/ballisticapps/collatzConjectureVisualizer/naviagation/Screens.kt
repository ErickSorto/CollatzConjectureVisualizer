...
import com.ballisticapps.collatzConjectureVisualizer.presentation.destinations.CollatzRecentScreenDestination
...
enum class Screens(val direction: DirectionDestinationSpec, val title: String, @DrawableRes val icon: Int) {
    ...
    HISTORY(CollatzRecentScreenDestination, "History", R.drawable.round_history_24),
